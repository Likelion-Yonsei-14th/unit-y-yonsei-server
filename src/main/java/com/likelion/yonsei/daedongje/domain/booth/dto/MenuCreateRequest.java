...
public record MenuCreateRequest(
        ...
        @Schema(description = "메뉴 이름", example = "핫도그") @NotBlank @Size(max = 50) String name,
        ...
        @Schema(description = "품절 여부", example = "false") @NotNull Boolean isSoldOut,

        @Schema(description = "메뉴 표시 순서", example = "1") Integer displayOrder) {
}